...
export function ComposerTimeoutBanner({
  ...
  return (
    <div
      className="relative z-0 mx-5 -mb-3 flex items-center gap-2 rounded-t-2xl border border-b-0 border-warning-foreground/30 bg-warning px-4 pb-5 pt-2.5 text-sm leading-5 text-foreground backdrop-blur-sm"
      data-testid="composer-timeout-banner"
    >
      <Clock aria-hidden className="size-4 shrink-0 text-warning-foreground" />
