...
export const PERSONA_FIELD_CONTROL_CLASS =
  "border-0 bg-transparent dark:bg-transparent dark:disabled:bg-transparent text-muted-foreground shadow-none outline-none ring-0 transition-colors duration-150 ease-out placeholder:text-muted-foreground focus:bg-transparent focus:text-muted-foreground focus:outline-hidden focus-visible:ring-0";
