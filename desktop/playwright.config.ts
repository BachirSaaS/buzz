  ...
  projects: [
    {
      ...
      testMatch: [
        ...
        "**/pulse-navigation.spec.ts",
        "**/pulse-canvas.spec.ts",
        "**/panel-workspace.spec.ts",
        "**/window-toolbar.spec.ts",
        "**/window-switching.spec.ts",
        "**/window-content-layout.spec.ts",
        "**/canvas-picker-preview.spec.ts",
        "**/pulse-workspaces.spec.ts",
        "**/pulse-home-chats.spec.ts",
        "**/workspace-planner.spec.ts",
        "**/workspace-management.spec.ts",
        "**/focus-layout.spec.ts",
        "**/interface-commands.spec.ts",
        "**/pulse-widgets.spec.ts",
