...
/// Return a minimal structurally-valid H.264/avc1 MP4 body (618 bytes).
///
/// Fast-start layout (ftyp + moov + mdat), single video track, 1 s, 320×240,
/// no audio.  Generated from the same builder as the unit tests and verified to
/// pass `validate_video_file` with the default `MediaConfig`.
///
/// Exposed only under `#[cfg(test)]` so it has no runtime cost; placed at
/// module scope (not inside `mod tests`) so other test modules in this crate
/// can import it via `use crate::validation::minimal_valid_mp4;`.
#[cfg(test)]
pub(crate) fn minimal_valid_mp4() -> Vec<u8> {
    // ftyp(isom) + moov + mdat — pre-computed; identical to
    // build_mp4_bytes(true, b"avc1", 1_000, 320, 240, false).
    vec![
        0x00, 0x00, 0x00, 0x14, 0x66, 0x74, 0x79, 0x70, 0x69, 0x73, 0x6f, 0x6d,
        0x00, 0x00, 0x00, 0x00, 0x69, 0x73, 0x6f, 0x6d, 0x00, 0x00, 0x02, 0x4e,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01, 0xda, 0x74, 0x72, 0x61, 0x6b,
        ...
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
        0x01, 0x40, 0x00, 0x00, 0x00, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x01, 0x76,
        0x6d, 0x64, 0x69, 0x61, 0x00, 0x00, 0x00, 0x20, 0x6d, 0x64, 0x68, 0x64,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x03, 0xe8, 0x00, 0x00, 0x03, 0xe8, 0x00, 0x00, 0x00, 0x00,
        ...
        0x21, 0x6d, 0x69, 0x6e, 0x66, 0x00, 0x00, 0x00, 0x14, 0x76, 0x6d, 0x68,
        ...
        ,
...
mod tests {
    ...
    /// Smoke-test: `minimal_valid_mp4()` (the bytes embedded for streaming upload
    /// tests) must round-trip through `validate_video_file`.  If this fails, the
    /// embedded byte sequence needs to be re-generated.
    #[test]
    fn test_minimal_valid_mp4_passes_validate_video_file() {
        let mp4_bytes = minimal_valid_mp4();
        let tmp = tempfile::NamedTempFile::new().unwrap();
        std::fs::write(tmp.path(), &mp4_bytes).unwrap();
        let result = validate_video_file(tmp.path(), &test_config());
        assert!(
            result.is_ok(),
            "minimal_valid_mp4() must pass validate_video_file; got: {result:?}"
        );
    }
